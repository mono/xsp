...
install: all
	...
	@echo ""
	@echo "-------------"
	@echo 'Now cd to server/test and run: mono xsp.exe or ./xsp.exe'
	@echo 'Then point your web browser to http://127.0.0.1:8080/'
	@echo 'You can change the default port (8080) in the xsp.exe.config file.'
	@echo ""
	...
	@echo "and/or DbConnectionString in xsp.exe.config file."
